...
culture = read.table(file.path(out_data_path,"1_culture_matrix.csv"), header=TRUE,sep=",",fill=TRUE,stringsAsFactors=FALSE)
#incorrect file path corrected - culture_condition folder not created in the code
#in addition - was saved under a different file name
