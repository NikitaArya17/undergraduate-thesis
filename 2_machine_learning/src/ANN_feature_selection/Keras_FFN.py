...
# read in data
df = pd.read_csv("/output_data/MLDB.csv")
...
setting_ = get_setting("/output_data/FFN_setting",line_num)
...
res_path = "/output_data/feature_selection/ANN/"+"gene_"+str(gene_index)+"_setting_"+str(line_num)
