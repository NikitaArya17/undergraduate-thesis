...
#SBATCH -o /home/nikita.arya/ensemble_pipeline/log/NB_feature_selection.o%j
#SBATCH -e /home/nikita.arya/ensemble_pipeline/log/NB_feature_selection.e%j
...
for i in {1..1990}
do
    echo "Rscript /home/nikita.arya/ensemble_pipeline/src/feature_selection.R $i 1" >> $CMD_FILE
done
