...
# read in data
df = pd.read_csv("/home/nikita.arya/ensemble_pipeline/output_data/MLDB.csv")
...
setting_ = get_setting("/home/nikita.arya/ensemble_pipeline/output_data/FFN_setting",line_num)
...
res_path = "/home/nikita.arya/ensemble_pipeline/output_data/feature_selection/ANN/"+"gene_"+str(gene_index)+"_setting_"+str(line_num)
