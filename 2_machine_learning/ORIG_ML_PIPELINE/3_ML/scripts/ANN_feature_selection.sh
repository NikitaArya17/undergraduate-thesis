...
#SBATCH -o /home/nikita.arya/ensemble_pipeline/log/ANN_feature_selection.o%j
#SBATCH -e /home/nikita.arya/ensemble_pipeline/log/ANN_feature_selection.e%j
...
do
 ...
 for j in {47..49}
  do
    echo "python /home/nikita.arya/ensemble_pipeline/src/Keras_FFN.py $i $j" >> $CMD_FILE
  done
