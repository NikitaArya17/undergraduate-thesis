...
head(out)
cat(file.path("/home/nikita.arya/ensemble_pipeline/output_data/feature_selection/NB_SVM/","feature_selection",ML_method,out_file))
write.csv(out,file = file.path("/home/nikita.arya/ensemble_pipeline/output_data/feature_selection/NB_SVM/","feature_selection",ML_method,out_file),row.names=FALSE)