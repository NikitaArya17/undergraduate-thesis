...
# It is unclear how this file was created:
...
#Added these lines to save the data locally
out_file <- unlist(lapply(bio_num, paste, collapse = ","))
write.csv(out_file, file.path(out_data_path, "Fig4/convergence_media.csv"))

setwd("C:/Xiaokang/Dropbox_drive/Mutation_DB_08_28_2016/stage 1 prepare the DB/Biological/6")
#This hard-coded path references the author's own Dropbox folder.
