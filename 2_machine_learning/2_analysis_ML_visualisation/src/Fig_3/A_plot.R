d1= read.csv("2_analysis_ML_visualisation/output_data/cluster_18.csv",header=TRUE,stringsAsFactors = FALSE)


cluster=d1[,-1] #mislabelled variable; corrected df to d1
